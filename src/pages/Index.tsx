  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="relative overflow-hidden bg-gradient-spotify border-b border-border">
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 lg:py-20 relative z-10 ml-0 md:ml-[22rem] transition-all duration-300" style={{ maxWidth: 'var(--container-max-width)' }}>
      ...
      {/* Main Content */}
      <div className="container mx-auto px-4 py-8 md:py-10 lg:py-12 relative z-10 ml-0 md:ml-[22rem] transition-all duration-300" style={{ maxWidth: 'var(--container-max-width)' }}>
        {/* Input Section */}
              ...
              <PlaylistInput 
                ...
                onPlaylistLoaded={(playlistData, tracksData, mode) => {
                  ...
                  if (mode === 'append' && playlist && tracks.length > 0) {
                    ...
                    // Smart naming: 
                    // - If adding ALL tracks from a playlist (2+ tracks), combine playlist names
                    // - If adding partial tracks, combine playlist names
                    // - Single track additions keep existing name
                    ...
                    if (isNewItemPlaylist) {
                      // Always combine names when adding a playlist (all or partial)
      ...
      <footer className="border-t border-border mt-16 md:mt-20 lg:mt-24 py-6 md:py-8 relative">
        <div className="container mx-auto px-4 ml-0 md:ml-[22rem] transition-all duration-300" style={{ maxWidth: 'var(--container-max-width)' }}>
